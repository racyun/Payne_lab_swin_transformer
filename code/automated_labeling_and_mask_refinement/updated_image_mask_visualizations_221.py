...
This notebook shows image and mask visualizations for 50 labeled samples. Each row contains four images: (1) the original image from the labeled dataset, (2) a visualization of the original mask, and (3–4) two updated masks generated by my brightness-based relabeling algorithm, designed to better capture background micrite and cement.
"""
