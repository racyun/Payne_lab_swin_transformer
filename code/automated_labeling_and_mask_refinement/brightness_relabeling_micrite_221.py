# -*- coding: utf-8 -*-
"""brightness relabeling_micrite_221
...
# --- Directories ---
out_mask_dir = Path("/content/drive/My Drive/carbonate_imgs_and_masks/petrographic_labelled_dataset/my_dataset/micrite_adjusted_masks")
